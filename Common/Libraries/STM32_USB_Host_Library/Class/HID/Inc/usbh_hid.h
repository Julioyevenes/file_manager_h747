...
#define HID_MAX_REPORT_ITEMS                        40U
...
/* Structure for storing the parsed dynamic descriptor */
typedef struct 
{
  HID_Report_ItemTypedef Item[HID_MAX_REPORT_ITEMS];
  uint8_t ItemNb;
} HID_ReportDesc_TypeDef;
...
typedef struct _HID_Process
{
  ...
  HID_ReportDesc_TypeDef Report_Items;
